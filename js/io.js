...
SQL.IO.prototype.downloadxml = function () {
  ...
  var projectName =
    this.owner.getOption("lastUsedName") ||
    this.lastUsedName ||
    this._name ||
    "default";
...
SQL.IO.prototype.clientlocalsave = function (silent) {
  ...
  if (silent === true) {
    key =
      this.owner.getOption("lastUsedName") || this.lastUsedName || "default";
  } else {
  ...
  try {
    ...
    alert(
      "Error saving database structure to localStorage! (" + e.message + ")"
    );
  }
};
...
SQL.IO.prototype.clientlocalload = function () {
  ...
  try {
    ...
    alert(
      "Error loading database structure from localStorage! (" + e.message + ")"
    );
    return;
  }
...
SQL.IO.prototype.clientlocallist = function () {
  ...
  try {
    ...
    alert(
      "Error loading database names from localStorage! (" + e.message + ")"
    );
    return;
  }
