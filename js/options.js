...
SQL.Options.prototype.build = function () {
  ...
  OZ.Event.add(
    this.dom.optionlocale,
    "change",
    this.handleLocaleChange.bind(this)
  );
  OZ.Event.add(this.dom.optiondb, "change", this.handleDBChange.bind(this));
  OZ.Event.add(
    this.dom.optionstyle,
    "change",
    this.handleStyleChange.bind(this)
  );
  OZ.Event.add(
    this.dom.optionshowtype,
    "change",
    this.handleShowTypeChange.bind(this)
  );
  OZ.Event.add(
    this.dom.optionshowsize,
    "change",
    this.handleShowSizeChange.bind(this)
  );
  OZ.Event.add(
    this.dom.optionshownull,
    "change",
    this.handleShowNullChange.bind(this)
  );

  // Add event listeners for AI configuration changes
  OZ.Event.add(
    this.dom.optionaiapikey,
    "input",
    this.handleAIConfigChange.bind(this)
  );
  OZ.Event.add(
    this.dom.optionaiagent,
    "change",
    this.handleAIConfigChange.bind(this)
  );
...
SQL.Options.prototype.save = function () {
  ...
  this.owner.setOption("shownull", this.dom.optionshownull.checked ? "1" : "");
